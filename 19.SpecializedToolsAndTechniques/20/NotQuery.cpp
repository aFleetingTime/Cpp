...
Chapter10::TextQuery::QueryResult NotQuery::eval(const Chapter10::TextQuery &tq) const
{
	Chapter10::TextQuery::QueryResult result = query.eval(tq);
	...
	return { result.getText(), { rep(), lineNo } };
}
